...
```bash
cargo test                           # run all tests (114 total)
cargo test --test features_golden_test  # AAMP, AB-join, top-k, motifs, discords, FLUSS, snippets, MPdist, SCRUMP, ostinato, STIMP, chains, MASS/match
