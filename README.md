...
|--:|-------:|---------:|--------:|
| 1,000 | 0.010s | 0.001s | **7.8x** |
| 5,000 | 0.059s | 0.009s | **6.5x** |
| 10,000 | 0.106s | 0.021s | **4.9x** |
| 25,000 | 0.307s | 0.083s | **3.7x** |
| 50,000 | 0.916s | 0.287s | **3.2x** |

### STIMP (pan matrix profile, m=10..100)

| n | stumpy | motif-rs | Speedup |
|--:|-------:|---------:|--------:|
| 1,000 | 1.221s | 0.033s | **37.5x** |
| 5,000 | 5.411s | 0.689s | **7.9x** |
| 10,000 | 11.550s | 1.561s | **7.4x** |

### Snippets (m=100, k=3)

| n | stumpy | motif-rs | Speedup |
|--:|-------:|---------:|--------:|
| 1,000 | 0.033s | 0.001s | **36.5x** |
| 5,000 | 0.693s | 0.017s | **39.8x** |
| 10,000 | 2.785s | 0.064s | **43.8x** |
| 25,000 | 17.526s | 0.319s | **55.0x** |

### MPdist (m=100, n_a = n_b)

| n | stumpy | motif-rs | Speedup |
|--:|-------:|---------:|--------:|
| 1,000 | 0.021s | 0.001s | **17.8x** |
| 5,000 | 0.113s | 0.010s | **11.7x** |
| 10,000 | 0.236s | 0.021s | **11.1x** |

### AAMP (non-normalized Euclidean, m=100)

| n | stumpy | motif-rs | Speedup |
|--:|-------:|---------:|--------:|
| 1,000 | 0.011s | 0.001s | **9.1x** |
| 5,000 | 0.092s | 0.014s | **6.7x** |
| 10,000 | 0.279s | 0.037s | **7.5x** |
| 25,000 | 1.327s | 0.197s | **6.7x** |

### AB-Join (m=100, n_a = n_b)

| n | stumpy | motif-rs | Speedup |
|--:|-------:|---------:|--------:|
| 1,000 | 0.011s | 0.001s | **7.8x** |
| 5,000 | 0.051s | 0.009s | **5.7x** |
| 10,000 | 0.112s | 0.020s | **5.5x** |
| 25,000 | 0.384s | 0.098s | **3.9x** |

### Top-k Nearest Neighbors (m=100, k=3)

| n | stumpy | motif-rs | Speedup |
|--:|-------:|---------:|--------:|
| 1,000 | 0.013s | 0.002s | **6.4x** |
| 5,000 | 0.074s | 0.017s | **4.5x** |
| 10,000 | 0.144s | 0.049s | **3.0x** |
| 25,000 | 0.397s | 0.227s | **1.7x** |

### Streaming STAMPI (m=50, +200 points)

| n_initial | stumpy | motif-rs | Speedup |
|----------:|-------:|---------:|--------:|
| 500 | 0.048s | 0.004s | **11.6x** |
| 1,000 | 0.055s | 0.006s | **9.0x** |
...
```bash
cargo test                           # run all tests (135 total)
cargo test --test features_golden_test  # AAMP, AB-join, top-k, motifs, discords, FLUSS, snippets, MPdist, SCRUMP, ostinato, STIMP, chains, MASS/match, MSTUMP, subspace, MDL, mmotifs
